<template>
  <!--  <div @click="router.push('print')">去打印</div>-->
  JavaScrip Api在安卓上存在较多兼容性问题
  <div @click="router.push('photo')">JS-去拍照</div>
  ...
  <div><a href="https://dev-apsmanage.rspaas.cn/#/demo">钉钉JsSdk-拍照&录音&扫码</a></div>
</template>
